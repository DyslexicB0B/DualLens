...
function renderStacked(){
  ...
  ctx.fillStyle="#fff";
  ctx.fillText(($("leftLabel").value||"LEFT LENS").toUpperCase(),x+28,y+38);
  ctx.textAlign="center";
  ...
  // Tight VS divider.
  y+=38;
  ctx.strokeStyle="rgba(7,18,41,.22)";
  ctx.lineWidth=2;
  ctx.beginPath();
  ctx.moveTo(120,y);
  ctx.lineTo(448,y);
  ...
  // Professional VS badge: navy pill with subtle inner ring.
  rr(468,y-28,144,56,28,"#071229","#ffffff",2);
  ctx.beginPath();
  ctx.roundRect(474,y-22,132,44,22);
  ctx.strokeStyle="rgba(255,255,255,.28)";
  ctx.lineWidth=1;
  ctx.stroke();

  ctx.font='900 24px "Roboto Condensed",Arial';
  ctx.fillStyle="#fff";
  ctx.fillText("VS",540,y+8);
  ...
  ctx.font='900 italic 31px "Roboto Condensed",Arial';
  ctx.fillStyle="#fff";
  ctx.fillText(($("rightLabel").value||"RIGHT LENS").toUpperCase(),x+28,y+38);
  ctx.textAlign="center";
