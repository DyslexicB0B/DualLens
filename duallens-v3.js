...
function render() {
  ...
  ctx.font = '900 58px "Arial Narrow", Arial';
  ...
  // Lens labels.
  ctx.font = '900 31px "Arial Narrow", Arial';
  ctx.fillStyle = "#185fe6";
  ctx.fillText("LEFT LENS", PAGE.left.x + PAGE.left.w / 2, 398);

  ctx.fillStyle = "#ef3038";
  ctx.fillText("RIGHT LENS", PAGE.right.x + PAGE.right.w / 2, 398);
  ...
  ctx.font = '900 28px "Arial Narrow", Arial';
  ctx.fillStyle = "#0d1730";
  ...
  ctx.font = '900 30px "Arial Narrow", Arial';
  ctx.fillStyle = "#0d1730";
