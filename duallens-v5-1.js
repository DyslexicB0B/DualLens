...
function renderStacked(){
  ...
  const lg=ctx.createRadialGradient(0,470,20,0,470,640);
  ...
  const rg=ctx.createRadialGradient(W,470,20,W,470,640);
  ...
  // Subtle contours, kept light.
  ctx.save();
  ctx.globalAlpha=.055;
  ctx.lineWidth=1.5;
  ctx.strokeStyle="#185fe6";
  for(let r=120;r<=560;r+=58){
    ctx.beginPath();ctx.arc(0,150,r,0,Math.PI*2);ctx.stroke();
  }
  ctx.strokeStyle="#ef3038";
  for(let r=120;r<=560;r+=58){
    ctx.beginPath();ctx.arc(W,150,r,0,Math.PI*2);ctx.stroke();
  }
  ctx.restore();

  // Compact top branding.
  logo(338,52,.84);
  ctx.fillStyle="#071229";
  ctx.font='900 54px "Roboto Condensed",Arial';
  ctx.fillText("DualLens",394,72);

  ctx.font='800 13px Arial';
  ctx.fillStyle="#344054";
  ctx.fillText("SAME STORY. DIFFERENT LENS.",394,96);

  // Headline uses less vertical space.
  text(
    $("headline").value.trim().toUpperCase(),
    540,
    155,
    970,
    58,
    '900 italic 62px "Roboto Condensed",Arial',
    "#071229",
    2,
    "center"
  );

  // Compact perspective meter.
  ctx.textAlign="center";
  ctx.font='900 15px "Roboto Condensed",Arial';
  ctx.fillStyle="#071229";
  ctx.fillText("PERSPECTIVE DISTANCE",540,250);

  meter($("distanceScore").value,315,270,350);

  ctx.font='900 16px "Roboto Condensed",Arial';
  ctx.fillStyle="#344054";
  ctx.fillText($("distanceCaption").value.trim().toUpperCase(),540,322);
  ...
  ctx.fillStyle="#fff";
  ctx.fillText("LEFT LENS",540,y+38);
  ...
  rr(480,y-24,120,48,24,"#167a9d","#071229",1.5);
  ctx.font='900 22px "Roboto Condensed",Arial';
  ctx.fillStyle="#fff";
  ...
  ctx.font='900 italic 31px "Roboto Condensed",Arial';
  ctx.fillStyle="#fff";
  ctx.fillText("RIGHT LENS",540,y+38);
  ...
  ctx.beginPath();
  ctx.moveTo(685,H-26);
  ctx.lineTo(1045,H-26);
  ctx.stroke();

  ctx.font='900 23px "Roboto Condensed",Arial';
  ctx.fillStyle="#fff";
  ctx.fillText("duallens.ai",540,H-18);
