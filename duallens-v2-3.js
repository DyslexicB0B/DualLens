...
const PAGE = {
  left:  { x: 58,  y: 312, w: 438, maxH: 808 },
  right: { x: 584, y: 312, w: 438, maxH: 808 }
};
...
function render() {
  ...
  ctx.beginPath();
  ctx.arc(W / 2 - 22, 52, 23, 0, Math.PI * 2);
  ctx.fill();
  ...
  ctx.textAlign = "center";
  ctx.font = "900 46px Arial Narrow, Arial";
  ctx.fillStyle = "#0d1730";
  ctx.fillText("DualLens", W / 2, 74);

  ctx.font = "800 14px Arial";
  ctx.fillStyle = "#667085";
  ctx.fillText("SAME STORY. DIFFERENT LENS.", W / 2, 106);
  ...
  drawText(
    ...
    960,
    58,
    "900 58px Arial Narrow, Arial",
    "#0d1730",
    3,
    "center"
  );

  ctx.font = "900 24px Arial Narrow, Arial";
  ctx.fillStyle = "#185fe6";
  ctx.fillText("LEFT LENS", PAGE.left.x + PAGE.left.w / 2, 278);
  ctx.fillStyle = "#ef3038";
  ctx.fillText("RIGHT LENS", PAGE.right.x + PAGE.right.w / 2, 278);
