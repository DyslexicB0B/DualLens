...
["headline","distanceScore","distanceCaption","leftLabel","rightLabel"].forEach(id=>$(id).addEventListener("input",()=>{$("distanceOutput").value=Number($("distanceScore").value).toFixed(1)+" / 10";render()}));
